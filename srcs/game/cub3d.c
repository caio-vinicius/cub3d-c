...
/*   Updated: 2020/07/20 20:41:35 by caio             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int argc, char *argv[])
{
	...
	game = setup(game);
	game_loop(0, &game);
	mlx_hook(game.vars.window, EKEYPRESS, MKEYPRESS, game_loop, &game);
	mlx_hook(game.vars.window, EKEYRELEASE, MKEYRELEASE, release_button, &game);
	mlx_hook(game.vars.window, EKEYDESTROY, MKEYDESTROY, x_exit, &game);
