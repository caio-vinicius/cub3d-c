...
#    Updated: 2020/06/16 13:49:26 by caio             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_CUB = cub_analyzecub.c cub_formatmap.c cub_ptrlen.c cub_getmap.c cub_getr.c cub_getrgb.c cub_ischarmap.c cub_isstrmap.c cub_iswall.c print_err_exit.c cub_validatemap.c cub_validatevars.c
