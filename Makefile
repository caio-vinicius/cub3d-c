...
#    Updated: 2020/07/20 23:59:50 by caio             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_INT = game_sets.c

SRCS_GAME = cub3d.c game_mlxpixelput.c game_drawline.c game_distancepoints.c game_normalizeangle.c game_iswalkable.c game_castray.c game_rendermap.c game_renderrays.c game_renderwalls.c game_renderbackground.c game_moveplayer.c game_castallrays.c game_loop.c game_print_exit.c game_validateargs.c game_validatescreen.c game_rendersprites.c $(SRCS_INT)
